...
class Profile extends Component {
    ...
    render = () => {
        ...
        return <div>
            ...
            <Row className="cardBorder" style={{ backgroundColor: "#f5f5f5", height: "30vh", position: "relative" }}>
                    ...
                    <Row >
                        ...
                        <Col md={3}>
                            <div className="vertical-center">
                                <Row>
                                    <Col md={1}>
                                        <div style={{ borderLeft: "1px solid rgb(167, 167, 167)", height: "90px" }} />
                                    </Col>
                                    <Col md={10}>
                                        <Row style={{ marginBottom: "15px" }}>
                                            <Col md={12}>
                                                <BsImage color="#0073bb" style={{ marginRight: "5px" }} />
                                                Add profile photo
                                            </Col>
                                        </Row>
                                        <Row>
                                            <Col md={12}>
                                                ...
                                                <Link to="/updateProfile" style={{ color: "#0073bb" }}>Update profile</Link></Col>
                                        </Row>
                                    </Col>
                                </Row>
                            </div>
                        ...
                        <Col md={3}>
                            <div style={{ marginTop: "70px", width: "80%", position: "absolute" }}>
                                ...
                                <ListGroup>
                                    ...
                                    <ListGroup.Item action onClick={() => { this.changeTab("following") }} style={{ marginBottom: "10px" }}>Following</ListGroup.Item>
                                </ListGroup>
                            </div>
                                ...
                                : (
                                    this.state.selectedTab === "events" ? (
                                        <div>
                                            ...
                                            <div>
                                                <h4 style={{ marginBottom: "20px", color: "red", marginLeft: "auto", marginRight: "auto", width: "93%" }}>Following Users</h4>
                                                <Container>
                                                    {
                                                        this.state.events.map((item) => {
                                                            return <Following event={item}></Following>
                                                        })
                                                    }
                                                </Container>
                                            </div>

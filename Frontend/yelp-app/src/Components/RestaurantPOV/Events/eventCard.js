...
import RegisteredUsers from '../../dialog/registeredUsers'
...
const Event = (props) => {
    ...
    return (
        <div>
            ...
            <RegisteredUsers users={props.registeredUsers} show={modalShow} onHide={() => setModalShow(false)} />:null}
            ...
            <Card style={{ width: '18rem' }}>
                ...
                <Card.Title>{props.eventName}</Card.Title>
                    ...
                    <hr/>
                    <Button onClick={() => setModalShow(true)} variant="danger" style = {{float: "right"}}>view Registered Users</Button>
                </Card.Body>
            </Card>
        </div>
    )

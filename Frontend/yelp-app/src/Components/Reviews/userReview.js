    ...
    return (
        <div>
            <Row style={{marginBottom:"20px"}}>
                <Col md={4}>
                    <Row>
                    <Image src={`https://yelpnivali.s3-us-west-2.amazonaws.com/profilee_${user.userId}`} style={{height:"200px",width:"100%"}} fluid></Image>
                    </Row>
                </Col>
                <Col md={8}>
                    <Row>
                        <Container>
                            ...
                            <Row>
                                ...
                                <h4 style={{ color: "#000000" }}> {user.userName}</h4>

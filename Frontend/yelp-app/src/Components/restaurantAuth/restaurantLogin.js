...
class RestaurantLogin extends Component {
  ...
  restaurantLogin = async (e, userType) => {
    ...
    let response = await this.props.restaurantLoginMutation({
      variables: {
        restaurantDetails: data
      }
    });

    let restaurant = { ...response.data.restaurantLogin };

    sessionStorage.setItem('name', restaurant.restaurantName);
...
export default compose(
  ...
  connect(mapStateToProps, { reslogin })(RestaurantLogin)
);